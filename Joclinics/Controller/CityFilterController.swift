...
class CityFilterController: UIViewController , UITableViewDelegate,  UITableViewDataSource{
    var list : [String] = FilterStruct().cityList
...
extension CityFilterController : ClinicsFilterTableViewCellDelegate{
