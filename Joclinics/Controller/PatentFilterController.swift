...
class PatentFilterController: UIViewController , UITableViewDelegate,  UITableViewDataSource   {
    var list : [String] = FilterStruct().specializationList
...
extension PatentFilterController : ClinicsFilterTableViewCellDelegate{
